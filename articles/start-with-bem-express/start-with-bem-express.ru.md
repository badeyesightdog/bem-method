...
Эта статья рассказывает о том, как создать динамический проект с использованием [БЭМ-платформы](https://ru.bem.info/platform/). Для изучения материала, представленного в статье, необходимо знание JavaScript.
